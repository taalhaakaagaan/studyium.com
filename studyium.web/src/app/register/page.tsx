    ...
    const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            try {
                ...
                throw new Error("Sunucu geçersiz bir yanıt döndürdü. Detay: " + (errorMsg || res.statusText));
            }
    ...
    const handleVerify = async (e: React.FormEvent) => {
        ...
        try {
            ...
            try {
                ...
                console.error("JSON Parse Error:", e, "Raw response:", text);
                const errorMsg = text.length > 200 ? text.substring(0, 200) + "..." : text;
                throw new Error("Doğrulama hatası (geçersiz yanıt). Detay: " + (errorMsg || res.statusText));
            }
            if (res.ok) {
