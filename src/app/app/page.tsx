                ...
                <div className="grid md:grid-cols-2 gap-6 pt-12 max-w-4xl mx-auto">
                    ...
                    <div className="p-8 rounded-2xl border border-border bg-card hover:shadow-xl transition-all group relative overflow-hidden">
                        ...
                        <div className="flex flex-col gap-3">
                            <a href="/downloads/Studyium-Windows.zip" className="inline-flex items-center justify-center w-full px-6 py-4 rounded-xl bg-primary text-primary-foreground font-bold hover:bg-primary/90 transition-all hover:scale-105 shadow-lg shadow-primary/20 gap-3">
                                <Download className="w-5 h-5" />
                                İndir (Taşınabilir Sürüm)
                            </a>
                    ...
                    <div className="p-8 rounded-2xl border border-border bg-card hover:shadow-xl transition-all group">
                        ...
                        <div className="flex flex-col gap-3">
                            <a href="/downloads/Studyium.AppImage" className="inline-flex items-center justify-center w-full px-6 py-4 rounded-xl bg-secondary text-secondary-foreground font-bold hover:bg-secondary/80 transition-all hover:scale-105 gap-3">
                                <Download className="w-5 h-5" />
                                İndir (.AppImage)
                            </a>
                            <p className="text-xs text-muted-foreground">
