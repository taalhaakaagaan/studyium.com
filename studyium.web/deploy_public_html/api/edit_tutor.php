...
$stmt = $conn->prepare("UPDATE tutors SET bio = ?, subjects = ?, course_details = ?, account_name = ?, iban = ?, active = ? WHERE id = ?");
$stmt->bind_param("ssssssi", $bio, $subjects, $course_details, $account_name, $iban, $active, $id);
