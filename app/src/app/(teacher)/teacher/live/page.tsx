        ...
        <div className="h-[calc(100vh-80px)] flex flex-col bg-zinc-950 text-white overflow-hidden rounded-xl">
                        ...
                        {isScreenSharing ? (
                            <div className="text-center">
                                ...
                                <h3 className="text-xl font-medium text-zinc-400">
                                    {(role === 'teacher' || role === 'tutor') ? "You are sharing your screen" : "Teacher is sharing screen"}
                                </h3>
                            </div>
                        ) : (
            ...
            <div className="h-20 bg-zinc-900 border-t border-zinc-800 flex items-center justify-between px-6 z-20">
                ...
                <div className="flex justify-end w-1/4">
                    <Link href={(role === 'teacher' || role === 'tutor') ? "/teacher/dashboard" : "/dashboard"} className="flex items-center gap-2 px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-full font-medium transition-colors">
                        <PhoneOff size={18} />
                        Leave
                    </Link>
                </div>
